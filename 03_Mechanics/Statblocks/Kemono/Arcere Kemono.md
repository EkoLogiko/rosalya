...
actions:
  - name: Attacco
    desc: "Attacco con arma a distanza: +5 al colpire, portata 18 m, un bersaglio. Colpito: 5 (1d6 + 2) danni taglienti, perforanti o contundenti."

# REAZIONI (Se il mostro non ne ha, cancella questa sezione)
reactions:
  - name: Quick Step
    desc: "Effettua un movimento di 1,5m prima di effettuare un attacco a distanza."